...
title: 'Avatars API'
icon: 'phone'
description: "Abstract's Avatars API is a fast, lightweight, modern, and RESTful JSON API for determining the validity and other details of phone numbers from over 190 countries."
