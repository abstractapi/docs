...
<Card title="Live exchange rates" icon="wave-pulse" href="exchange-rates/live">
...
<Card title="Convert exchange rates" icon="money-bill-transfer" href="exchange-rates/convert">
  The `convert` endpoint is similar to the `live` endpoint, except it allows you to convert an arbitrary amount of currency.
</Card>

<Card title="Historical exchange rates (beta)" icon="landmark" href="exchange-rates/historical">
