...
<Card title="Current time endpoint" icon="clock" href="timezones/current-time">
...
<Card title="Convert timezones endpoint" icon="clock-rotate-left" href="timezones/convert-time">
